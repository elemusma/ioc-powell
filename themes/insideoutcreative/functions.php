...
function powell_restoration_stylesheets() {
...
if(is_front_page() || is_page_template('templates/services.php') || is_page_template('templates/team.php') || is_page_template('templates/about.php')){
...
wp_enqueue_style('font-nexa-new', get_theme_file_uri('/font-nexa-new/font-nexa.css'));
// wp_enqueue_style('magallenes', '//use.typekit.net/rdk8ifp.css');


}
add_action('wp_enqueue_scripts', 'powell_restoration_stylesheets');
// for footer
function powell_restoration_stylesheets_footer() {
...
add_action('get_footer', 'powell_restoration_stylesheets_footer');
...
function powell_restoration_menus() {
...
add_action('after_setup_theme', 'powell_restoration_menus');
